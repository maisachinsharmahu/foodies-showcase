...
class GiffyModal extends StatelessWidget {
  ...
  ///   content: Container(width: 200.w, height: 200.h, color: Colors.green),
  ///   actions: <Widget>[
  ///     ElevatedButton(onPressed: () {}, child: const Text('Button 1')),
  ///     ElevatedButton(onPressed: () {}, child: const Text('Button 2')),
  ///   ],
  ///   actionsPadding: EdgeInsets.symmetric(horizontal: 8.0.w),
  /// )
  /// ```
  /// {@end-tool}
  ///
  ...
  Widget build(BuildContext context) {
    ...
    if (actions != null) {
      final defaultActionsPadding = theme.useMaterial3
          ? EdgeInsets.only(left: 24.0.w, right: 24.0.w, bottom: 24.0.h)
          : EdgeInsets.zero;
